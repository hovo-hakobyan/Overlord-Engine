...
// VERTEX SHADER *
//****************
VS_OUTPUT MainVS(VS_INPUT vsData)
{
	VS_OUTPUT o;
	o.vertex = vsData.vertex;
	o.normal = vsData.normal;
	o.tangent = vsData.tangent;
    return o;
}
...
[maxvertexcount(3)]
void BladeGenerator(triangle VS_OUTPUT IN[3],inout TriangleStream<GS_DATA> triStream)
{
